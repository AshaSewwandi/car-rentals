...
<head>
    ...
    @include('partials.seo-meta', [
        'title' => 'Rental Blogs | R&A Auto Rentals',
        'description' => 'Read practical rental guides from R&A Auto Rentals, including trip planning, vehicle selection, mileage control, and booking tips.',
        'keywords' => [
            'car rental blog',
            'rental tips',
            'trip planning',
