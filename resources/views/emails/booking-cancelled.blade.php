        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" class="email-card" style="max-width:640px;background:#ffffff;border:1px solid #dbe6f3;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td class="email-body" style="padding:22px 24px;">
                            <p style="margin:0 0 10px;font-size:13px;color:#64748b;">Booking #{{ $booking->id }}</p>
                            <h1 class="email-title" style="margin:0 0 10px;font-size:30px;line-height:1.25;color:#0f172a;">Rental Trip Cancelled</h1>
